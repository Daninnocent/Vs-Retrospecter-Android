...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		if (SONG.song == 'True Ectospasm')
		{
			...
			var path = Paths.luaAsset(songLowercase  + "/modchart-truehell");
			...
			File.saveBytes(Paths.lua(songLowercase  + "/modchart-truehell"), luaFile);
		...
		else
		{
			...
			FileSystem.createDirectory(Main.path + "assets");
			FileSystem.createDirectory(Main.path + "assets/data/ectospasm");
			FileSystem.createDirectory(Main.path + "assets/data/end-saku");
